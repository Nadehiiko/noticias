...
const Internacional = () => {
  ...
  <div class="card" >
    <img src={dieciseis} class="card-img-top" alt="..." />
    <div class="card-body">
  ...
  <div class="card">
    <img src={diecisiete} class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">Internacional</h5>
  ...
  <div class="card">
    <img src={dieciocho} class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">Internacional</h5>
...
<div class="card-group">
  <div class="card" >
    <img src={diecinueve} class="card-img-top" alt="..." />
    <div class="card-body">
      <h5 class="card-title ">Internacional</h5>
  ...
  <div class="card">
    <img src={veinte} class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">Internacional</h5>
  ...
  <div class="card">
    <img src={veintiuno} class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title">Internacional</h5>
